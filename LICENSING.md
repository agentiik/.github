...
| [deploy](https://github.com/agentiik/deploy)<br>[.github](https://github.com/agentiik/.github)<br>[terraform-provider-agentiik](https://github.com/agentiik/terraform-provider-agentiik) | Apache-2.0 | Configuration and templates people copy into their own infrastructure, and the provider that applies them. Copyleft on a provider would reach into the infrastructure code that calls it, which is somebody else's work. |
